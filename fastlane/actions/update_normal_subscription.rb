module Fastlane
  module Actions
    module SharedValues
      UPDATE_NORMAL_SUBSCRIPTION_CUSTOM_VALUE = :UPDATE_NORMAL_SUBSCRIPTION_CUSTOM_VALUE
    end

    class UpdateNormalSubscriptionAction < Action
      def self.run(params)
        ...
        for i in 0..iaps.size - 1
            if iaps.at(i).product_id == product_id
                ...
                if review_pic_url != nil and reviews_pic-url != ""
                    puts "review_pic_url"
                ...
                if review_pic_url == ""
                    puts "review_pic_url"
                    e.review_screenshot = review_pic_url
                end
      ...
      def self.output
        ...
        # Example
        [
          ['UPDATE_NORMAL_SUBSCRIPTION_CUSTOM_VALUE', 'A description of what this value contains']
        ]
      end
